...
{
    /// <summary>
    /// Đọc/ghi config.json tại %AppData%\SymbolReplacer\config.json.
    ...
    public class ConfigService : IConfigService
    {
        ...
        {
            // Tạo thư mục %AppData%\SymbolReplacer\ nếu chưa có
            string appData = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
            string dir     = Path.Combine(appData, "SymbolReplacer");
