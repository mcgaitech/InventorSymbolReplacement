...
namespace MCGInventorPlugin.Views.SymbolHandler
{
    ...
    /// PaletteController dùng qua SymbolHandlerPanel.SymbolGrid:
    ...
    public class WpfSymbolGrid
    {
        ...
        /// Gọi từ SymbolHandlerPanel constructor sau InitializeComponent().
        /// </summary>
        ...
        /// Internal vì cũng được dùng bởi SymbolHandlerPanel.SetSelectedSymbolProperties().
        /// </summary>
